...
| PDF knowledge and RAG     | Index policy PDFs; Cross-document RAG; Document-scoped query; Insufficient evidence; Unsafe knowledge question or document  | curl                                | [Index](docs/manual-testing.md#knowledge-indexing-and-rag-successfailure) · [Cross-document](docs/rag-testing-and-troubleshooting.md#51-cross-document-grounded-answer) · [Document-scoped](docs/rag-testing-and-troubleshooting.md#52-query-one-document) · [Insufficient evidence](docs/rag-testing-and-troubleshooting.md#54-insufficient-evidence) · [Unsafe query](docs/rag-testing-and-troubleshooting.md#55-unsafe-knowledge-question) · [Unsafe document](docs/knowledge-indexing.md#safe-version-publication) |
